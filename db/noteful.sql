...
-- ALTER TABLE notes ADD COLUMN folder_id int REFERENCES folders ON DELETE RESTRICT;

-- If you delete a folder then delete all notes that reference the folder
-- IOW, delete a folder and all the notes in it
-- ALTER TABLE notes ADD COLUMN folder_id int REFERENCES folders ON DELETE CASCADE;
